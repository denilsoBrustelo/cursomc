...
public class DBService {
	...
	public void intantiateTestDatabase() throws ParseException
	{
	    ...
	    Cliente cli1 = new Cliente(null, "Denilso F. Brustelo", "denilso.fabiano@ima.sp.gov.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
	    cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
	    
	    Cliente cli2 = new Cliente(null, "Ana Costa", "dfb@ima.sp.gov.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
	    cli2.addPerfil(Perfil.ADMIN);
	    cli2.getTelefones().addAll(Arrays.asList("33363323","93548393"));
	    
	    
	    Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
	    Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
	    Endereco e3 = new Endereco(null, "Avenida Floriano", "105", null, "Centro", "1212121", cli2, c2);
